...
export default function VolunteerDashboard() {
  const { user, profile, events, bookings, isLoading, createUserBooking, cancelBooking, updateDateOfBirth } = useVolunteerData();
