    ...
    return (
        ...
        <div style={{ padding: "24px 20px 20px", borderBottom: "1px solid #f1f5f9" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <Image src="/newLogo.png" alt="Ladles of Love Logo" width={80} height={45} style={{ objectFit: "contain" }} />
            <div>
        ...
        <div style={{ padding: "16px", borderTop: "1px solid #f1f5f9", display: "flex", alignItems: "center", gap: "10px" }}>
          <div style={{ width: "36px", height: "36px", borderRadius: "50%", background: "#1a1a1a", display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", fontWeight: "700", fontSize: "13px", flexShrink: 0 }}>AT</div>
          <div>
            <div style={{ fontSize: "12px", color: "#1a1a1a", fontWeight: "700" }}>Admin Test</div>
